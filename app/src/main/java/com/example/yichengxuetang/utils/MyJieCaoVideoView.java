...
public class MyJieCaoVideoView extends JCVideoPlayer {
    ...
    public MyJieCaoVideoView(Context context) {
        super(context);
    }

    public MyJieCaoVideoView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public int getLayoutId() {
        return R.layout.jc_layout_standard_my;
    }
    ...
    public void startDismissControlViewTimer() {
        ...
        mDismissControlViewTimerTask = new MyJieCaoVideoView.DismissControlViewTimerTask();

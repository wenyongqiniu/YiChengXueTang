...
public class ViewPager2Adapter2 extends RecyclerView.Adapter<ViewPager2Adapter2.ViewPager2ViewHolder> {
    private static final String TAG = "ViewPager2Adapter";
    private List<QuestionInfoResponse.DataBean> list_vp2_data;
    ...
    public ViewPager2Adapter2(ArrayList<QuestionInfoResponse.DataBean> list, Context context, QuestionBankContract.QuestionBankPresenter mPresenter, String questionTitle) {
    ...
    @NonNull
    @Override
    public ViewPager2Adapter2.ViewPager2ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_vp_exam, parent, false);
        return new ViewPager2ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewPager2Adapter2.ViewPager2ViewHolder holder, int position) {

        QuestionInfoResponse.DataBean dataBean = list_vp2_data.get(position);
        ...
        QuestionAnswerAdapter2 questionAnswerAdapter = new QuestionAnswerAdapter2(R.layout.item_question_list, dataBean.getAnswerList(), dataBean, mPresenter, rl_anlisy, holder.tv_your_answer, questionTitle, position);

...
public class MuluSlimuTitleAdapter extends BaseQuickAdapter<BatchMenuListSimluResponse.DataBean, BaseViewHolder> {
    ...
    public MuluSlimuTitleAdapter(int layoutResId, @Nullable List<BatchMenuListSimluResponse.DataBean> data, int number) {

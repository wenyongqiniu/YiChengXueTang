...
欢迎页适配器
 */
public class SmartDohomeworkAdapter extends PagerAdapter {
    ...
    public SmartDohomeworkAdapter(ArrayList<QuestionListResponse.DataBean.DataListBean> list, Context context, QuestionBankContract.QuestionBankPresenter mPresenter, String questionTitle) {
        this.list = list;
   ...
   /* @Override
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        ...
        QuestionAnswerAdapter questionAnswerAdapter = new QuestionAnswerAdapter(R.layout.item_question_list, dataBean.getAnswerList(), dataBean, mPresenter, rl_anlisy, tv_your_answer, questionTitle, position);

...
public class TestExerciseActivity extends MvpActivity<MainContract.MainPresenter> implements MainContract.IMainView {
    ...
    public void initData(Bundle savedInstanceState) {
        StatusBarUtils.setColor(this, Color.parseColor("#FFECE4"));
        StatusBarUtils.setTextDark(this, true);
    }

    @Override
    public int getLayoutId() {
        return R.layout.activity_test_exercise;
    }
}